...
-klsn_rule_alias([
    {jsonrpc_message_from_json, {with_defs,
                                 {#{<<"JSONRPCError">> =>
                                     {struct,
                                      #{error =>
                                         {required,
                                          {ref,<<"JSONRPCErrorError">>}},
                                        id =>
                                  ...
                                  {any_of,
                                   [{ref,<<"JSONRPCRequest">>},
                                    ...
                                    {ref,<<"JSONRPCResponse">>},
                                    {ref,<<"JSONRPCError">>}]}}}},
    {jsonrpc_message_to_json, {with_defs,
                               {#{<<"JSONRPCError">> =>
                                   {struct,
                                    #{error =>
                                       {required,
                                ...
                                {any_of,
                                 [{ref,<<"JSONRPCRequest">>},
                                  ...
                                  {ref,<<"JSONRPCResponse">>},
                                  {ref,<<"JSONRPCError">>}]}}}},
    {jsonrpc_request_from_json, {with_defs,
                                 {#{<<"RequestId">> =>
                                     {any_of,[binstr,integer]}},
                                  {struct,
                                   #{id => {required,{ref,<<"RequestId">>}},
                                     params => {optional,term},
                                     method => {required,binstr}}}}}},
    {jsonrpc_request_to_json, {with_defs,
                                  {#{<<"RequestId">> =>
                                         {any_of,[binstr,integer]}},
                                   {struct,
                                       #{id =>
                                         ...
                                         params => {optional,term},
                                         method => {required,binstr}}}}}},
    {jsonrpc_notification_from_json, {struct,
                                      #{params => {optional,term},
                                        method => {required,binstr}}}},
    {jsonrpc_notification_to_json, {struct,
                                       #{params => {optional,term},
                                         method => {required,binstr}}}},
    {jsonrpc_response_from_json, {with_defs,
                                  {#{<<"RequestId">> =>
                                      {any_of,[binstr,integer]}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      result => {required,term}}}}}},
    {jsonrpc_response_to_json, {with_defs,
                                {#{<<"RequestId">> =>
                                    {any_of,[binstr,integer]}},
                                 {struct,
                                  #{id => {required,{ref,<<"RequestId">>}},
                                    result => {required,term}}}}}},
    {jsonrpc_error_from_json, {with_defs,
                               {#{<<"JSONRPCErrorError">> =>
                                   {struct,
                                    #{code => {required,integer},
                                      data => {optional,term},
                                ...
                                {struct,
                                 #{error =>
                                   ...
                                   id => {required,{ref,<<"RequestId">>}}}}}}},
    {jsonrpc_error_to_json, {with_defs,
                             {#{<<"JSONRPCErrorError">> =>
                                 {struct,
                                  #{code => {required,integer},
                                    data => {optional,term},
                              ...
                              {struct,
                               #{error =>
                                  {required,{ref,<<"JSONRPCErrorError">>}},
                                 id => {required,{ref,<<"RequestId">>}}}}}}},
    {client_request_from_json, {with_defs,
                                {#{<<"ThreadArchiveParams">> =>
                                   ...
                                   <<"RemoveConversationListenerParams">> =>
                                    {struct,
                                     #{subscriptionId => {required,binstr}}},
                                 ...
                                 {any_of,
                                  [{struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,{ref,<<"InitializeParams">>}},
                                      method =>
                                       {required,{enum,[initialize]}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ThreadStartParams">>}},
                                      method =>
                                       {required,{enum,['thread/start']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ThreadResumeParams">>}},
                                      method =>
                                       {required,{enum,['thread/resume']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,{ref,<<"ThreadForkParams">>}},
                                      method =>
                                       {required,{enum,['thread/fork']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ThreadArchiveParams">>}},
                                      method =>
                                       {required,{enum,['thread/archive']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ThreadSetNameParams">>}},
                                      method =>
                                       {required,{enum,['thread/name/set']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ThreadUnarchiveParams">>}},
                                      method =>
                                       {required,
                                        {enum,['thread/unarchive']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ThreadCompactStartParams">>}},
                                      method =>
                                       {required,
                                        {enum,['thread/compact/start']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ThreadRollbackParams">>}},
                                      method =>
                                       {required,{enum,['thread/rollback']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,{ref,<<"ThreadListParams">>}},
                                      method =>
                                       {required,{enum,['thread/list']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ThreadLoadedListParams">>}},
                                      method =>
                                       {required,
                                        {enum,['thread/loaded/list']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,{ref,<<"ThreadReadParams">>}},
                                      method =>
                                       {required,{enum,['thread/read']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,{ref,<<"SkillsListParams">>}},
                                      method =>
                                       {required,{enum,['skills/list']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"SkillsRemoteReadParams">>}},
                                      method =>
                                       {required,
                                        {enum,['skills/remote/read']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"SkillsRemoteWriteParams">>}},
                                      method =>
                                       {required,
                                        {enum,['skills/remote/write']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,{ref,<<"AppsListParams">>}},
                                      method =>
                                       {required,{enum,['app/list']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"SkillsConfigWriteParams">>}},
                                      method =>
                                       {required,
                                        {enum,['skills/config/write']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,{ref,<<"TurnStartParams">>}},
                                      method =>
                                       {required,{enum,['turn/start']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"TurnInterruptParams">>}},
                                      method =>
                                       {required,{enum,['turn/interrupt']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ReviewStartParams">>}},
                                      method =>
                                       {required,{enum,['review/start']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,{ref,<<"ModelListParams">>}},
                                      method =>
                                       {required,{enum,['model/list']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"McpServerOauthLoginParams">>}},
                                      method =>
                                       {required,
                                        {enum,['mcpServer/oauth/login']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params => {optional,{exact,null}},
                                      method =>
                                       {required,
                                        {enum,['config/mcpServer/reload']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ListMcpServerStatusParams">>}},
                                      method =>
                                       {required,
                                        {enum,['mcpServerStatus/list']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"LoginAccountParams">>}},
                                      method =>
                                       {required,
                                        {enum,['account/login/start']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"CancelLoginAccountParams">>}},
                                      method =>
                                       {required,
                                        {enum,['account/login/cancel']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params => {optional,{exact,null}},
                                      method =>
                                       {required,{enum,['account/logout']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params => {optional,{exact,null}},
                                      method =>
                                       {required,
                                        {enum,['account/rateLimits/read']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"FeedbackUploadParams">>}},
                                      method =>
                                       {required,{enum,['feedback/upload']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"CommandExecParams">>}},
                                      method =>
                                       {required,{enum,['command/exec']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,{ref,<<"ConfigReadParams">>}},
                                      method =>
                                       {required,{enum,['config/read']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ConfigValueWriteParams">>}},
                                      method =>
                                       {required,
                                        {enum,['config/value/write']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ConfigBatchWriteParams">>}},
                                      method =>
                                       {required,
                                        {enum,['config/batchWrite']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params => {optional,{exact,null}},
                                      method =>
                                       {required,
                                        {enum,['configRequirements/read']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,{ref,<<"GetAccountParams">>}},
                                      method =>
                                       {required,{enum,['account/read']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                   ...
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      ...
                                      method =>
                                       {required,
                                        {enum,[getConversationSummary]}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ListConversationsParams">>}},
                                      method =>
                                       {required,{enum,[listConversations]}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ResumeConversationParams">>}},
                                      method =>
                                       {required,
                                   ...
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ForkConversationParams">>}},
                                      method =>
                                       {required,{enum,[forkConversation]}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ArchiveConversationParams">>}},
                                      method =>
                                       {required,
                                        {enum,[archiveConversation]}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"SendUserMessageParams">>}},
                                      method =>
                                       {required,{enum,[sendUserMessage]}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"SendUserTurnParams">>}},
                                      method =>
                                       {required,{enum,[sendUserTurn]}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                   ...
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      ...
                                      method =>
                                       {required,
                                        {enum,[removeConversationListener]}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"GitDiffToRemoteParams">>}},
                                      method =>
                                       {required,{enum,[gitDiffToRemote]}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"LoginApiKeyParams">>}},
                                      method =>
                                       {required,{enum,[loginApiKey]}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params => {optional,{exact,null}},
                                      method =>
                                       {required,{enum,[loginChatGpt]}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"CancelLoginChatGptParams">>}},
                                      method =>
                                       {required,
                                        {enum,[cancelLoginChatGpt]}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params => {optional,{exact,null}},
                                      method =>
                                       {required,{enum,[logoutChatGpt]}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"GetAuthStatusParams">>}},
                                      method =>
                                       {required,{enum,[getAuthStatus]}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params => {optional,{exact,null}},
                                      method =>
                                       {required,
                                        {enum,[getUserSavedConfig]}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"SetDefaultModelParams">>}},
                                      method =>
                                       {required,{enum,[setDefaultModel]}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params => {optional,{exact,null}},
                                      method =>
                                       {required,{enum,[getUserAgent]}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params => {optional,{exact,null}},
                                   ...
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ExecOneOffCommandParams">>}},
                                      method =>
                                       {required,
                                        {enum,[execOneOffCommand]}}}}]}}}},
    {client_request_to_json, {with_defs,
                              {#{<<"ThreadArchiveParams">> =>
                                  {struct,#{threadId => {required,binstr}}},
                                 <<"TurnStartParams">> =>
                                  {struct,
                               ...
                               {any_of,
                                [{struct,
                                 ...
                                 {struct,
                                  #{id => {required,{ref,<<"RequestId">>}},
                                    params =>
                                     {required,{ref,<<"ThreadStartParams">>}},
                                    method =>
                                     {required,{enum,['thread/start']}}}},
                                 {struct,
                                  #{id => {required,{ref,<<"RequestId">>}},
                                  ...
                                  #{id => {required,{ref,<<"RequestId">>}},
                                    params =>
                                     {required,
                                      {ref,<<"ThreadUnarchiveParams">>}},
                                    method =>
                                     {required,{enum,['thread/unarchive']}}}},
                                 {struct,
                                  #{id => {required,{ref,<<"RequestId">>}},
                                    params =>
                                     {required,
                                 ...
                                 {struct,
                                  #{id => {required,{ref,<<"RequestId">>}},
                                    params =>
                                     {required,{ref,<<"ReviewStartParams">>}},
                                    method =>
                                     {required,{enum,['review/start']}}}},
                                 {struct,
                                  #{id => {required,{ref,<<"RequestId">>}},
                                 ...
                                 {struct,
                                  #{id => {required,{ref,<<"RequestId">>}},
                                    params =>
                                     {required,{ref,<<"CommandExecParams">>}},
                                    method =>
                                     {required,{enum,['command/exec']}}}},
                                 {struct,
                                  #{id => {required,{ref,<<"RequestId">>}},
                                  ...
                                  #{id => {required,{ref,<<"RequestId">>}},
                                    params =>
                                     {required,
                                      {ref,<<"ResumeConversationParams">>}},
                                    method =>
                                     {required,{enum,[resumeConversation]}}}},
                                 {struct,
                                  #{id => {required,{ref,<<"RequestId">>}},
                                    params =>
                                     {required,
                                 ...
                                 {struct,
                                  #{id => {required,{ref,<<"RequestId">>}},
                                    params =>
                                     {required,{ref,<<"LoginApiKeyParams">>}},
                                    method =>
                                     {required,{enum,[loginApiKey]}}}},
                                 {struct,
                                  #{id => {required,{ref,<<"RequestId">>}},
                                  ...
                                  #{id => {required,{ref,<<"RequestId">>}},
                                    params =>
                                     {required,
                                      {ref,<<"CancelLoginChatGptParams">>}},
                                    method =>
                                     {required,{enum,[cancelLoginChatGpt]}}}},
                                 {struct,
                                  #{id => {required,{ref,<<"RequestId">>}},
                                    params => {optional,{exact,null}},
                                    method =>
                                 ...
                                 {struct,
                                  #{id => {required,{ref,<<"RequestId">>}},
                                    params => {optional,{exact,null}},
                                    method =>
                                     {required,{enum,[getUserSavedConfig]}}}},
                                 {struct,
                                  #{id => {required,{ref,<<"RequestId">>}},
                                    params =>
                                     {required,
                                 ...
                                 {struct,
                                  #{id => {required,{ref,<<"RequestId">>}},
                                    ...
                                    method =>
                                     {required,
                                      {enum,[execOneOffCommand]}}}}]}}}},
    {client_notification_from_json, {any_of,
                                     [{struct,
                                       #{method =>
                                          {required,{enum,[initialized]}}}}]}},
    {client_notification_to_json, {any_of,
                                   [{struct,
                                     #{method =>
                                        {required,{enum,[initialized]}}}}]}},
    {server_request_from_json, {with_defs,
                                  ...
                                  [{struct,
                                   ...
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"DynamicToolCallParams">>}},
                                      method =>
                                       {required,{enum,['item/tool/call']}}}},
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                   ...
                                   {struct,
                                    #{id => {required,{ref,<<"RequestId">>}},
                                      params =>
                                       {required,
                                        {ref,<<"ExecCommandApprovalParams">>}},
                                      method =>
                                       {required,
                                        {enum,[execCommandApproval]}}}}]}}}},
    {server_request_to_json, {with_defs,
                              {#{<<"ApplyPatchApprovalParams">> =>
                                  {struct,
                                   #{reason =>
                                      {optional,
                                ...
                                [{struct,
                                 ...
                                 {struct,
                                  #{id => {required,{ref,<<"RequestId">>}},
                                    params =>
                                     {required,
                                      {ref,<<"ToolRequestUserInputParams">>}},
                                    method =>
                                     {required,
                                  ...
                                  #{id => {required,{ref,<<"RequestId">>}},
                                    params =>
                                     {required,
                                      {ref,<<"ApplyPatchApprovalParams">>}},
                                    method =>
                                     {required,{enum,[applyPatchApproval]}}}},
                                 {struct,
                                  #{id => {required,{ref,<<"RequestId">>}},
                                    params =>
                                     {required,
                                    ...
                                    method =>
                                     {required,
                                      {enum,[execCommandApproval]}}}}]}}}},
    {server_notification_from_json, {with_defs,
                                     {#{<<"PatchChangeKind">> =>
                                         {any_of,
                                          [{struct,
                                            #{type =>
                                        ...
                                        <<"CollabAgentTool">> =>
                                         {enum,
                                          [spawnAgent,sendInput,wait,
                                           closeAgent]},
                                        <<"ItemStartedNotification">> =>
                                         {struct,
                                          #{item =>
                                             {required,{ref,<<"ThreadItem">>}},
                                            threadId => {required,binstr},
                                            turnId => {required,binstr}}},
                                        <<"RateLimitWindow">> =>
                                         {struct,
                                       ...
                                       [{struct,
                                        ...
                                        {struct,
                                         #{params =>
                                           ...
                                           method =>
                                            {required,
                                             {enum,[sessionConfigured]}}}}]}}}},
    {server_notification_to_json, {with_defs,
                                   {#{<<"PatchChangeKind">> =>
                                       {any_of,
                                        [{struct,
                                          #{type => {required,{enum,[add]}}}},
                                      ...
                                      {struct,
                                       #{params =>
                                         ...
                                         method =>
                                          {required,
                                           {enum,[sessionConfigured]}}}}]}}}},
    {codex_event_notification_from_json, {with_defs,
                                          {#{<<"McpStartupStatus">> =>
                                              {any_of,
                                               [{struct,
                                                 #{state =>
    ...
    {codex_event_notification_to_json, {with_defs,
                                        {#{<<"McpStartupStatus">> =>
                                            {any_of,
                                             [{struct,
                                               #{state =>

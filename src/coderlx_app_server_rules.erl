                                ...
                                {#{<<"McpStartupStatus">> =>
                                     ...
                                     [{struct,
                                      ...
                                      {struct,
                                       #{id =>
                                         ...
                                         status =>
                                          {required,
                                           {ref,<<"LocalShellStatus">>}},
                                         type =>
                                          {required,{enum,[local_shell_call]}},
                                         action =>
                                          {required,
                                           {ref,<<"LocalShellAction">>}},
                                         call_id =>
                                          {optional,
                                           {any_of,[binstr,{exact,null}]}}}},
                                      {struct,
                                   ...
                                   <<"SandboxPolicy">> =>
                                    {any_of,
                                     [{struct,
                                      ...
                                      {struct,
                                       #{type =>
                                          {required,{enum,['read-only']}}}},
                                      {struct,
                                       #{type =>
                                          {required,
                                           {enum,['external-sandbox']}},
                                         network_access =>
                                          {optional,
                                           {default,
                                            {<<"restricted">>,
                                   ...
                                   <<"FunctionCallOutputContentItem">> =>
                                    {any_of,
                                     [{struct,
                                       #{type =>
                                          {required,{enum,[input_text]}},
                                         text => {required,binstr}}},
                                      {struct,
                                       #{type =>
                                          {required,{enum,[input_image]}},
                                         image_url => {required,binstr}}}]},
                                   <<"PlanType">> =>
                                    {enum,
                                     ...
                                     [{struct,
                                      ...
                                      {struct,
                                       #{message => {required,binstr},
                                         ...
                                         local_images =>
                                          {optional,
                                           {default,{[],{list,binstr}}}}}},
                                      {struct,#{delta => {required,binstr}}},
                                      {struct,#{text => {required,binstr}}},
                                      {struct,#{delta => {required,binstr}}},
                                      {struct,#{text => {required,binstr}}},
                                      {struct,#{delta => {required,binstr}}},
                                      {struct,
                                      ...
                                      {struct,
                                       #{result =>
                                         ...
                                         duration =>
                                          {required,{ref,<<"Duration">>}}}},
                                      {struct,#{call_id => {required,binstr}}},
                                      {struct,
                                       #{query => {required,binstr},
                                         action =>
                                          {required,
                                      ...
                                      {struct,
                                       #{message =>
                                          {optional,
                                           {any_of,[binstr,{exact,null}]}},
                                         type =>
                                          {required,{enum,[undo_started]}}}},
                                      {struct,
                                       #{message =>
                                          {optional,
                                           {any_of,[binstr,{exact,null}]}},
                                         type =>
                                          {required,{enum,[undo_completed]}},
                                         success => {required,boolean}}},
                                      {struct,
                                       #{message => {required,binstr},
                                         type =>
                                          {required,{enum,[stream_error]}},
                                         codex_error_info =>
                                          {optional,
                                           {default,
                                            {null,
                                      ...
                                      {struct,
                                       #{reason =>
                                          {required,
                                           {ref,<<"TurnAbortReason">>}},
                                         type =>
                                          {required,{enum,[turn_aborted]}}}},
                                      {struct,
                                       #{type =>
                                          {required,
                                           {enum,[shutdown_complete]}}}},
                                      {struct,
                                       #{type =>
                                          {required,
                                           {enum,[entered_review_mode]}},
                                         target =>
                                          {required,{ref,<<"ReviewTarget">>}},
                                         user_facing_hint =>
                                          {optional,
